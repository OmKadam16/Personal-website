...
const socialLinks = [
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/om-kadam-3a6495328/',
    icon: (
  ...
  {
    label: 'GitHub',
    href: 'https://github.com/OmKadam16',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/om_kadam4/',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
      ...
      <div className="hero-content">
        <div className="hero-left">
          ...
          <p className="hero-tagline">
            Builder and researcher at the intersection of AI, biology, and
            human potential.
          </p>
        </div>
